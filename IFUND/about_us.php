...
<?php				
    ...
    <header class="pt100 pb100 parallax-window-2" data-parallax="scroll" data-speed="0.5" data-image-src="assets/img/bg/<?php echo $row['about_bg_image']?>" data-positionY="1000">
        <div class="intro-body text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 pt50">
                        <h1 class="brand-heading font-montserrat text-uppercase color-light" data-in-effect="fadeInDown"><?php echo $row['about_main_title']?><small class="color-light alpha7"><?php echo $row['about_sub_title']?></small></h1>
                    </div>
                </div>
            </div>
        </div>
