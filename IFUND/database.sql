...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2016 at 10:45 AM
...
-- Database: `ifund_data`
--
CREATE DATABASE IF NOT EXISTS `ifund_data` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `ifund_data`;
...
(1, 'Address has to be updated', '123-456-789', 'email@domain.com', 'contact_us.jpg', 'Contact Us', 'Drop a Message');
...
CREATE TABLE `double_port` (
  `id` int(3) NOT NULL,
  `double_min_amt` float NOT NULL,
  `double_max_amt` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `double_port` (`id`, `double_min_amt`, `double_max_amt`) VALUES
(1, 10000, 15000);
...
CREATE TABLE `full_port` (
  `id` int(3) NOT NULL,
  `full_min_amt` float NOT NULL,
  `full_max_amt` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `full_port` (`id`, `full_min_amt`, `full_max_amt`) VALUES
(1, 16000, 50000);
...
(1, 'Our Partners', 'Drop a Message1', 'partners.jpg');
