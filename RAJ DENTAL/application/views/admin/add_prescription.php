          ...
          <div class="prescription_details">
            ...
            <input type="hidden" name="case_history_id" id="case_history_id" value="<?php echo $p_info->case_history_id ?>" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">                        
                        <textarea id="med_history" class="form-control" name="med_history"><?php echo $p_info->med_history ?></textarea>
                    </div>
                </div>
                    ...
                    <table id="medication" class="table add_prescription" >
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td>
                                <input class="form-control input-sm" id="qty_1" name="qty[]" type="text" placeholder="">
                            </td>
