    ...
    <section class="content">
        ...
        <form enctype="multipart/form-data" method="post" action="<?php echo base_url(). 'admin/new_patient_create'; ?>" class="form-horizontal form-groups-bordered" id="new_patient_create" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" id="p_name" class="form-control" name="p_name" data-inputmask="'alias': 'a', 'repeat': 100,'greedy' : false" data-mask>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" id="p_phone" class="form-control" name="p_phone" data-inputmask="'alias': '9', 'repeat': 13,'greedy' : false" data-mask>
                        </div>
                    </div>
