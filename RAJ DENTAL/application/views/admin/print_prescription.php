        ...
        <div class="modal-body">
          ...
          <div class="prescription_details">            
            ...
            <div class="part-1">
                <div class="row">
                    <div class="col-sm-12">
                        <p><span class="title">Previous Medical History :</span> <?php echo $case_info->med_history ?></p>
                    </div>                    
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <p><span class="title">Treatment Type :</span> <?php echo $case_info->treat_type .' ' .$case_info->treat_details ?></p>
                    </div>                    
                </div>
            </div>
