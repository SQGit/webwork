...
?>
  ...
  <tr>
    <td align="center" style="font-size:14px;">
      <strong>NOTICE OF INTENTION TO APPEAR<br>AVIS D’INTENTION DE COMPARAÎTRE</strong>
    </td>
  </tr>
  ...
  <tr>
      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody>
        <tr>
          <td width="21%" style="font-size:14px;">
          ...
          <td width="58%">&nbsp;</td>
          <td width="21%" style="font-size:14px;"><strong><i>Form / Formule 7</i></strong><br>
  ...
  <tr>
    <td class="text1">TAKE NOTICE THAT I
      <input type="text" style="width:75%;"value="<?php echo $tickets_detail->customer_name;?>" readonly></td>
  </tr>
  ...
  <tr>
    <td><table width="100%" cellspacing="1" cellpadding="1" border="0" style="font-size:14px;">
        <tbody><tr>
          <td width="70%">wish to give notice of my intention to appear in court to enter a plea of not guilty at the time and place set for the trial respecting the charge set out in the Offence Notice or Parking Infraction Notice</td>
          <td width="30%">
            <input type="text" style="width:90%;" size="25" value="<?php echo $tickets_detail->notice_number;?>" readonly>
            <br>
        ...
        <tr>
          ...
          <td><label>
            <input type="text" style="width:90%;" value="<?php echo $tickets_detail->offence_date;?>" readonly>
  ...
  <tr>
    <td><table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody><tr>
          <td width="49%" style="font-size:14px;">FOR ANY OFFENCE EXCEPT s.s. 144(18.1) OF THE HTA COMPLETE THIS SECTION:</td>
          <td width="51%" style="font-size:14px;"><i>POUR TOUTE INFRACTION NON VISÉE AU PARAGRAPHE 144 (18.1) DU CODE DE LA ROUTE, REMPLIR CETTE SECTION:</i></td>
        </tr>
        <tr>
          <td style="font-size:14px;">I intend to challenge the Provincial Offences Officer’s evidence. I request that the officer attend the trial</td>
          <td style="font-size:14px;"><i>J’ai l’intention de contester la preuve de l’agent des infractions provinciales. Je demande que l’agent assiste au procès</i></td>
        </tr>
  ...
  <tr>
    <td><table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody><tr>
          ...
          <td width="51%" style="padding-left:4px;"><strong>Remarque:</strong><br>
  ...
  <tr>
    <td><table width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
          <td>I request a
            <label>
            <input type="text" style="background-color:#F4F4F4; width:70%;" value="<?php echo $tickets_detail->trial_lang_ip;?>" readonly>
            </label>
            language interpreter for the trial. (leave blank if inapplicable)</td>
          <td><i>Je demande l’aide d’un interprète de langue
            <label>
            <input type="text" style="background-color:#F4F4F4;  width:70%;" id="fr_languageinterpreter" name="fr_languageinterpreter">
            </label>
  ...
  <tr>
    <td><table width="100%" cellspacing="1" cellpadding="1" border="0">
        ...
        <tr>
          <td><label>
            <input type="text" style="width:90%;background-color:#F4F4F4;" readonly>
            <br>
            </label>
          ...
          <td valign="top"><label>
            <input type="text" style="background-color:#F4F4F4; width:90%;" value="<?php echo $tickets_detail->filed_date;?>" readonly>
