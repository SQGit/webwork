...
<section class="file_ticket">
        <div class="container">
            <div>
                <h3>File Your Red Light Ticket</h3>
                <hr/>
                <div class="ticket-note">
                    <h4>Please Note:</h4>
                        <h5 id="date_error">Red Light Tickets MUST be less than 30 days old.</h5>
                        <br/>
                        <p>The issue date of your City Of Toronto Red Light Ticket must be less than 30 days. If you received your Red Light Ticket more than 30 days ago, we are unable to file it through our website, sorry!</p>
                </div>
                
                <div class="ticket-date">
                    Please Enter your Red Light Ticket Offence Date:
                    <form>
                    <div class="row">
...
<section class="ticket_form slideDown">
    <div class="container">
    <br><br>
    <form class="form-horizontal form" id="file_ticket" method="POST" action="red_light_tkt">
      <div class="col-md-10 col-md-offset-1">    
       <!-- Progress Bar -->
        ...
        <div class="row box">
            ...
            <h4>Step 1 <a type="button" style="font-size:14px;" data-toggle="modal" data-target="#red_light_ticket">(Click here to see sample form)</a></h4>
            <input type="hidden" id="ticket_name" name="ticket_name" value="Red Light Ticket">
            ...
            <div class="step slideLeft">
            <h4>step 2 <a type="button" style="font-size:14px;" data-toggle="modal" data-target="#red_light_ticket">(Click here to see sample form)</a></h4>
            <div class="field_group">
...
<!-- Modal -->
  <div class="modal fade" id="red_light_ticket" role="dialog" style="z-index:99999;">
    <div class="modal-dialog" style="width:860px;">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="text-align:center;">Sample Red Light Ticket Form</h4>
        </div>
        <div class="modal-body">
          <img src="<?php echo base_url().'assets/img/red_light_ticket.png' ?>" alt="sample traffic ticket" />
        </div>
